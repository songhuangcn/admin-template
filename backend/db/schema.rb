...
ActiveRecord::Schema[7.0].define(version: 2023_06_18_150502) do
  ...
  create_table "roles_permissions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["permission_name"], name: "index_roles_permissions_on_permission_name"
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.integer "user_type", default: 1, null: false, comment: "用户类型(1普通用户 2管理员)"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
